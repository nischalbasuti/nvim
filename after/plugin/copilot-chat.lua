...
-- Toggle chat window
vim.keymap.set('n', '<leader>ct', ":CopilotChatToggle<CR>", { desc = "CopilotChat - Toggle Window" })
vim.keymap.set('v', '<leader>ct', ":CopilotChatToggle<CR>", { desc = "CopilotChat - Toggle Window" })
vim.keymap.set('v', '<leader>cct', ":CopilotChatToggle<CR>", { desc = "CopilotChat - Toggle Window" })
